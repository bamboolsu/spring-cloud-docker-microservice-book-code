...
echo XXXXXXXX 
echo 2, access http://localhost:8080/microservice-foo/dev
...
echo XXXXXXXX 
echo 3, access http://localhost:8080/microservice-foo-dev.properties
echo profile: dev-1.0-test   test: 1
echo XXXXXXXX


echo XXXXXXXX 
echo 4, access http://localhost:8080/config-label-v2.0/microservice-foo-dev.properties
