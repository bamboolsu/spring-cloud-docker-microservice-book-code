...
echo XXXXXXXX  spring-boot-starter-actuator
cd ../../microservice-consumer-movie-feign/target/
echo  start java -jar  microservice-consumer-movie-feign-0.0.1-SNAPSHOT.jar   --server.port=8010
start java -jar  microservice-consumer-movie-feign-0.0.1-SNAPSHOT.jar   --server.port=8010
echo XXXXXXXX end  consumer-movie-feign
