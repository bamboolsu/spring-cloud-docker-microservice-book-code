...
echo XXXXXXXX
echo ５, start　启动　hystrix-dashboard
echo http://localhost:8030/hystrix   http://localhost:8030/hystrix.stream
echo XXXXXXXX
...
echo XXXXXXXX 
echo ６, start 访问 http://localhost:8040/microservice-consumer-movie/user/1  请求会被转发到 http://localhost:8010/user/1
echo XXXXXXXX


echo XXXXXXXX 
echo ７, start 访问 http://localhost:8040/hystrix.stream 
echo XXXXXXXX

echo XXXXXXXX 
echo 8, start 访问 http://localhost:8030/hystrix
echo XXXXXXXX
