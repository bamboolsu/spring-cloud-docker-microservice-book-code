...
echo XXXXXXXX 
echo 5, start 访问 http://localhost:8040/microservice-consumer-movie/user/1  请求会被转发到 http://localhost:8010/user/1
echo XXXXXXXX


echo XXXXXXXX 
echo 6, start 访问 http://localhost:8040/microservice-provider-user/1  请求会被转发到 http://localhost:8000/1
echo XXXXXXXX
