...
cd ../../microservice-gateway-zuul-file-upload/target/
echo  start java -jar  microservice-gateway-zuul-file-upload-0.0.1-SNAPSHOT.jar 
start java -jar  microservice-gateway-zuul-file-upload-0.0.1-SNAPSHOT.jar 
echo XXXXXXXX 
