...
echo  start java -jar  microservice-consumer-movie-feign-hystrix-fallback-stream-0.0.1-SNAPSHOT.jar   --server.port=8010
start java -jar  microservice-consumer-movie-feign-hystrix-fallback-stream-0.0.1-SNAPSHOT.jar   --server.port=8010
echo XXXXXXXX end  consumer-movie-feign-hystrix-fallback-stream
