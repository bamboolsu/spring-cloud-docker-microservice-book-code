...
echo XXXXXXXX
echo 1, start 启动
cd ../../trace/microservice-simple-provider-user-trace-elk/target/
echo start java -jar  microservice-simple-provider-user-trace-elk-0.0.1-SNAPSHOT.jar  --server.port=8000   --spring.profiles.active=test 
start java -jar  microservice-simple-provider-user-trace-elk-0.0.1-SNAPSHOT.jar
cd ../
echo XXXXXXXX end  simple-provider-user-trace-elk
